...
//   const [email, setEmail] = useState("manavdelvadiya7972@gmail.com");
//   const [password, setPassword] = useState("manavdelvadiya7972@gmail.com");
...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center px-4">
      <form className="w-full max-w-sm bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6 text-center">
